  ...
  if (step === 'confirm') {
    return (
      <div style={{ marginTop: '12px', padding: '16px', borderRadius: '14px', background: 'rgba(255,107,53,0.08)', border: '1px solid rgba(255,107,53,0.25)' }}>
        ...
        <p style={{ fontSize: '13px', color: '#9B93C0', marginBottom: '14px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          ...
          <button
            ...
            style={{ flex: 1, padding: '10px', borderRadius: '10px', fontSize: '13px', fontWeight: 600, background: 'rgba(255,255,255,0.06)', color: '#9B93C0', border: '1px solid rgba(255,255,255,0.1)', cursor: 'pointer' }}
          >
            Cancel
          </button>
        </div>
