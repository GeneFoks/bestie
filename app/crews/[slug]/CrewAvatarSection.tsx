  ...
  return (
    <div style={{ position: 'relative', flexShrink: 0 }}>
      ...
      <div
        ...
        style={{ width: '80px', height: '80px', borderRadius: '20px', overflow: 'hidden', background: 'var(--surface-3)', border: '2px solid rgba(212,175,55,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: isCaptain ? 'pointer' : 'default', position: 'relative' }}
      >
        {uploading ? (
