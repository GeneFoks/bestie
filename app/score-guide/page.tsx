    ...
    <div style={{ minHeight: '100vh', background: '#080810', fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          ...
          <h1 style={{ fontFamily: 'DM Serif Display, serif', fontSize: '36px', fontWeight: 700, color: '#E8E0FF', marginBottom: '12px' }}>How the system works</h1>
        ...
        <div style={{ background: '#0F0F1E', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '20px', padding: '24px', marginBottom: '20px' }}>
          <h2 style={{ fontFamily: 'DM Serif Display, serif', fontSize: '20px', color: '#E8E0FF', marginBottom: '20px' }}>Score levels</h2>
          {[
            { range: '800–1000', label: 'Excellent', color: '#39FF14', desc: 'Top Bestie. High trust, active, verified.' },
            { range: '600–799', label: 'Good', color: '#D4AF37', desc: 'Reliable and social. Strong track record.' },
            { range: '400–599', label: 'Fair', color: '#9B93C0', desc: 'In progress. Keep completing sessions.' },
            { range: '50–399', label: 'New', color: '#9B93C0', desc: 'Just started. Fill your profile — Score will grow fast.' },
          ].map(s => (
        ...
        {/* Profile points */}
        <div style={{ background: '#0F0F1E', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '20px', padding: '24px', marginBottom: '20px' }}>
          <h2 style={{ fontFamily: 'DM Serif Display, serif', fontSize: '20px', color: '#E8E0FF', marginBottom: '8px' }}>Profile</h2>
          <p style={{ fontSize: '13px', color: '#9B93C0', marginBottom: '20px' }}>Awarded once when completed</p>
          {[
        ...
        {/* Penalties */}
        <div style={{ background: '#0F0F1E', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '20px', padding: '24px', marginBottom: '20px' }}>
          <h2 style={{ fontFamily: 'DM Serif Display, serif', fontSize: '20px', color: '#E8E0FF', marginBottom: '8px' }}>Penalties & degradation</h2>
          <p style={{ fontSize: '13px', color: '#9B93C0', marginBottom: '20px' }}>Score decreases with inactivity or poor reviews</p>
          {[
          ...
          <p style={{ fontSize: '12px', color: '#9B93C0', marginTop: '12px' }}>Minimum score is always 50 — you can always recover.</p>
        </div>
