  ...
  return (
    <div style={{ minHeight: '100vh', background: '#080810', fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
      ...
      <nav style={{ position: 'sticky', top: 0, zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 24px', background: 'rgba(8,8,16,0.9)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <Link href="/blog" style={{ fontSize: '14px', color: '#9B93C0', textDecoration: 'none', padding: '8px 16px', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.1)' }}>← Blog</Link>
      </nav>
      ...
      <article style={{ maxWidth: '720px', margin: '0 auto', padding: '60px 24px' }}>
        ...
        <h1 style={{ fontFamily: 'DM Serif Display, serif', fontSize: 'clamp(24px, 5vw, 40px)', fontWeight: 700, color: '#E8E0FF', lineHeight: 1.2, marginBottom: '16px' }}>{post.title}</h1>
        {post.description && <p style={{ fontSize: '17px', color: '#9B93C0', lineHeight: 1.6, marginBottom: '24px' }}>{post.description}</p>}

        <p style={{ fontSize: '13px', color: '#6B6490', marginBottom: '40px', paddingBottom: '24px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div style={{ marginTop: '60px', padding: '28px', background: '#0F0F1E', border: '1px solid rgba(212,175,55,0.2)', borderRadius: '20px', textAlign: 'center' }}>
          <p style={{ fontSize: '18px', fontWeight: 700, color: '#E8E0FF', marginBottom: '8px' }}>Ready to find your people?</p>
          <p style={{ fontSize: '14px', color: '#9B93C0', marginBottom: '20px' }}>Join Bestie and start making real connections today.</p>
          <Link href="/login" style={{ display: 'inline-block', padding: '12px 28px', borderRadius: '12px', fontSize: '14px', fontWeight: 700, background: 'linear-gradient(135deg, #D4AF37 0%, #B8960C 100%)', color: '#080810', textDecoration: 'none' }}>
            Join Bestie Free →
          </Link>
        </div>
      </article>
