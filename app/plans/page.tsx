    ...
    <div style={{ background: '#09090F', minHeight: '100vh', fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        .nav-link { color: #A99ECC; text-decoration: none; transition: color 0.2s; font-size: 14px; }
      ...
      <header style={{ position: 'relative', paddingTop: '120px', paddingBottom: '20px', paddingLeft: '20px', paddingRight: '20px', overflow: 'hidden', textAlign: 'center' }}>
        ...
        <div style={{ maxWidth: '720px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ fontFamily: 'DM Serif Display, serif', fontSize: 'clamp(30px, 6vw, 52px)', fontWeight: 700, color: '#F0EAFF', lineHeight: 1.1, marginBottom: '16px', letterSpacing: '-0.5px' }}>
            Plans for crews<br /><em style={{ color: '#9B7FFF', fontStyle: 'italic' }}>and for you.</em>
          </h1>
          <p style={{ fontSize: '15px', color: '#A99ECC', maxWidth: '520px', margin: '0 auto', lineHeight: 1.7 }}>
      ...
      <footer style={{ borderTop: '1px solid #161628', padding: '32px 24px' }}>
        <div style={{ maxWidth: '980px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '14px' }}>
          ...
          <div style={{ display: 'flex', gap: '20px', fontSize: '13px', flexWrap: 'wrap' }}>
            <Link href="/" style={{ color: '#6B6490', textDecoration: 'none' }}>Home</Link>
            <Link href="/crews" style={{ color: '#6B6490', textDecoration: 'none' }}>Crews</Link>
            <Link href="/plus" style={{ color: '#6B6490', textDecoration: 'none' }}>Bestie Plus</Link>
            <Link href="/terms" style={{ color: '#6B6490', textDecoration: 'none' }}>Terms</Link>
            <Link href="/privacy" style={{ color: '#6B6490', textDecoration: 'none' }}>Privacy</Link>
            <Link href="/signup" style={{ color: '#6B6490', textDecoration: 'none' }}>Join</Link>
          </div>
